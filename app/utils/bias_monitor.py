"""
Bias Monitoring Utilities
Track and analyze performance across demographic groups
"""
...
class DemographicGroup:
    ...
    category: str  # e.g., 'race', 'gender', 'age_group'
    group_name: str  # e.g., 'male', 'female', '18-25', etc.
...
class BiasMonitor:
    """
    Monitor and analyze bias in face recognition system.
    ...
    def compute_fairness_metrics(
        ...
        Args:
            predictions: Dict mapping group_name -> predictions
            ground_truth: Dict mapping group_name -> ground_truth
        ...
        # 2. Equalized Odds Difference (based on FAR and FRR)
    ...
    def check_bias_threshold(
        ...
        Args:
            ...
            threshold: Acceptable bias threshold
            
        Returns:
            Tuple[bool, List[str]]: (has_bias, violations)
        """
        violations = []
    ...
    def analyze_embedding_bias(
        ...
        """
        Analyze bias in embedding space.
        
        Args:
            embeddings: Face embeddings
            demographic_labels: Demographic group labels
            
        Returns:
            Dict[str, float]: Bias analysis metrics
        """
    ...
    def recommend_mitigation(
        ...
        Returns:
            List[str]: Mitigation recommendations
        """
        recommendations = []
...
def get_bias_monitor() -> BiasMonitor:
    """
    Get singleton bias monitor instance.
