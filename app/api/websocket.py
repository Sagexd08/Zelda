"""
WebSocket Handler
Real-time video streaming for face authentication
"""
...
class WebSocketConnectionManager:
    """
    Manages WebSocket connections for real-time authentication.
    """
    ...
    async def process_frame(
        ...
        """
        Process a video frame for authentication.
        ...
        try:
            ...
            # Add frame to temporal liveness buffer
            ...
            # Send liveness feedback
            await self.send_message(websocket, {
                'status': 'liveness_passed',
                'liveness_score': float(liveness_score)
            })
            
            # Temporal liveness check (if enough frames)
            temporal_live = True
...
async def websocket_endpoint(websocket: WebSocket, client_id: str):
    """
    WebSocket endpoint for real-time authentication.
