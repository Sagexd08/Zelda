  ...
  theme: {
    extend: {
      colors: {
        ...
        accent: {
          DEFAULT: '#00BFFF', // Sky blue for highlights
          light: '#4dd0ff',
          dark: '#0099cc',
        },
        neon: {
        ...
        dark: {
          DEFAULT: '#0A0F1C', // Main dark background
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
          300: '#cbd5e1',
      ...
      backgroundImage: {
        ...
        'gradient-neon': 'linear-gradient(135deg, #00BFFF 0%, #87CEEB 100%)',
      },
      borderRadius: {
        '2xl': '1rem',
        '3xl': '1.5rem',
